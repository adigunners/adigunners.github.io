...
const corsProxies = [
  ...
  'https://api.codetabs.com/v1/proxy?quest=' +
    encodeURIComponent('https://fantasy.premierleague.com/api/bootstrap-static/'),
  'https://new-proxy.com/api?url=' +
    encodeURIComponent('https://fantasy.premierleague.com/api/bootstrap-static/'), // Add new proxy
];
```
...
_For issues not covered in this guide, consult the [Technical Documentation](TECHNICAL_DOCUMENTATION.md) or [API Reference](API_REFERENCE.md)._
