...
window.LeaderboardEnhancement = (function () {
   ...
   * @deprecated Server-side enhanced JSON now provides movement data directly in
   * player.movement. This function remains for backward compatibility when enhanced JSON
   * is unavailable.
